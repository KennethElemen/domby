...
<div class="wrapperAlert error" style="height: 550px;">
  ...
  <div class="contentAlert">
    ...
    <div class="bottomHalf">
         <p>Reservation cancellation unsuccessful. An error occurred.</p>
          
        <p>There might be an issue with your cancellation request. Please ensure that the information provided is accurate and try again.</p>
...
<script>
    document.getElementById('alertMO').addEventListener('click', function() {
        window.location.href = '../Guest/cancel.php';
    });
</script>
</body>
</html>
