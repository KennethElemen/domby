...
<div class="wrapperAlert error" style="height: 550px;">
  ...
  <div class="contentAlert">
   ...
   <div class="bottomHalf">
        <p>Email not found in the account list.</p>
        
        <p>It seems that the provided email is not associated with any account. Please double-check the email address you entered or consider creating a new account if you haven't already.</p>
        
        <p>If you believe there's an error, you can go back and verify the information.</p>
