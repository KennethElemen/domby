...
<div class="wrapperAlert error" style="height: 550px;">
  ...
  <div class="contentAlert">
    ...
    <div class="bottomHalf">
          <p>Payment unsuccessful. An error occurred.</p>
          
          <p>There might be an issue with your payment. Please check the information provided and ensure that the payment details are accurate.</p>
          
        
          <button id="alertMO">Try again</button>
      </div>
