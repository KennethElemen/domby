...
function sendOTP($email) {
    ...
    $subject = 'Your OTP for Reservation';
    $message = '
    <!DOCTYPE html>
    <html lang="en-US">
                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding: 0 35px;">
                                            <h1 style="color: #1e1e2d; font-weight: 500; margin: 0; font-size: 32px; font-family:  sans-serif;">Reschedule</h1>
   ...
   // Check if the reservation status is set
    if ($stmt->num_rows > 0) {
        if ($status === 'Accepted') {
            ...
            // Send OTP
           if (sendOTP($email)) {
                $_SESSION['submitted_email'] = $email; // Set the session variable here
                echo "<script>
                        Swal.fire({
                            icon: 'success',
                            title: 'OTP Sent',
                            ...
                            willClose: () => {
                                window.location.href = 'resecheduleOTP.php';
                            }
                        });
                    </script>";
                exit();
    ...
    <div class="container-fluid page-body-wrapper full-page-wrapper">
        <div class="content-wrapper d-flex align-items-center auth">
            <div class="col-lg-5 col-md-8 col-sm-10 mx-auto text-left">
                <div class="card">
                    <div class="card-body">
                        <h1 class="Mb-12">Reschule Form<ul class="list-arrow">
